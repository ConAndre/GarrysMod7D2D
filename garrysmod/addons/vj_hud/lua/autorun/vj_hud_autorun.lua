...
if (CLIENT) then
	local AddConvars = {}
	AddConvars["vj_hud_enabled"] = 1 -- Enable VJ HUD
	AddConvars["vj_hud_health"] = 1 -- Enable health and suit
	AddConvars["vj_hud_ammo"] = 1 -- Enable ammo
	AddConvars["vj_hud_ammo_invehicle"] = 1 -- Should the ammo be enabled in the vehicle?
	AddConvars["vj_hud_compass"] = 1 -- Enable compass
	AddConvars["vj_hud_playerinfo"] = 1 -- Enable local player information
	AddConvars["vj_hud_trace"] = 1 -- Enable trace information
	AddConvars["vj_hud_trace_limited"] = 1 -- Should it only display the trace information when looking at a player or an NPC?
	AddConvars["vj_hud_scanner"] = 1 -- Enable proximity scanner
	AddConvars["vj_hud_metric"] = 0 -- Use KPH instead of MPH
	AddConvars["vj_hud_ch_enabled"] = 0 -- Enable VJ Crosshair
	AddConvars["vj_hud_ch_invehicle"] = 0 -- Should the Crosshair be enabled in the vehicle?
	AddConvars["vj_hud_ch_crosssize"] = 50 -- Crosshair Size
	AddConvars["vj_hud_ch_opacity"] = 255 -- Opacity of the Crosshair
	AddConvars["vj_hud_ch_r"] = 0 -- Crosshair Color - Red
	AddConvars["vj_hud_ch_g"] = 255 -- Crosshair Color - Green
	AddConvars["vj_hud_ch_b"] = 0 -- Crosshair Color - Blue
	AddConvars["vj_hud_ch_mat"] = 0 -- Crosshair Material - 1
	AddConvars["vj_hud_disablegmod"] = 1 -- Disable Garry's Mod HUD
	AddConvars["vj_hud_disablegmodcross"] = 1 -- Disable Garry's Mod Crosshair
	
	for k, v in pairs(AddConvars) do
		if !ConVarExists(k) then CreateClientConVar(k, v, {FCVAR_ARCHIVE}) end
	end
	/*
	...
	*/
	---------------------------------------------------------------------------------------------------------------------------
	local function VJ_HUD_SETTINGS(Panel)
		Panel:ControlHelp(" ") -- Spacer
		Panel:ControlHelp("Select Default to reset the changes")
	...
	hook.Add("PopulateToolMenu", "VJ_ADDTOMENU_HUD_SETTINGS", function()
		spawnmenu.AddToolMenuOption("DrVrej", "HUDs", "VJ HUD Settings", "Settings", "", "", VJ_HUD_SETTINGS, {})
	end)
end
