...
ENT.TimedSpawn_Time = 25 -- How much time until it spawns another SNPC?
...
function ENT:SpawnAnEntity(keys,values,initspawn)
	...
	local playerTableP = ents.FindInSphere( pos, 600 )
	...
	if isplayernear && v.TheEntity then 
...
function ENT:Initialize()
	...
	for k,v in ipairs(self.EntitiesToSpawn) do 
		self:SpawnAnEntity(k,v,true) end
