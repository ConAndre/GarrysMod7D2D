...
-----------------------------------------------*/
ENT.Model = {"models/blacktea/zpszombie1.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = GetConVarNumber("vj_zss_zps_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_zss_zps_d")
