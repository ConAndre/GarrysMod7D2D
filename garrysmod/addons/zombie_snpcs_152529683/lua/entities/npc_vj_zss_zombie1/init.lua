...
-----------------------------------------------*/
ENT.Model = {"models/zombie/zclassic_01.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = GetConVarNumber("vj_zss_slowz_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_zss_slowz_d")
...
function ENT:MultipleMeleeAttacks()
	...
	if randattack == 1 then
		...
		self.MeleeAttackDamage = GetConVarNumber("vj_zss_slowz_d")
	elseif randattack == 2 then
		self.AnimTbl_MeleeAttack = {"vjseq_attacke","vjseq_attackf"}
		self.TimeUntilMeleeAttackDamage = 1
		self.MeleeAttackDamage = GetConVarNumber("vj_zss_slowz_d_hard")
	end
end
/*-----------------------------------------------
	*** Copyright (c) 2012-2018 by DrVrej, All rights reserved. ***
