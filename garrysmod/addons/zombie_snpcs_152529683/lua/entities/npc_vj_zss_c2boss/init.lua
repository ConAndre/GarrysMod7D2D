...
ENT.NextLeapAttackTime = 12 -- How much time until it can use a leap attack?
...
-- Custom
ENT.FastZombie_Skin = 0
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:CustomOnInitialize()
	self:SetCollisionBounds(Vector(13, 13, 50), Vector(-13, -13, 0))
	self:SetModelScale(2.5, 0)
	if self.FastZombie_Skin != 0 then
		self:SetSkin(self.FastZombie_Skin)
	end
end
/*-----------------------------------------------
	*** Copyright (c) 2012-2018 by DrVrej, All rights reserved. ***
